...
class TestParseCSVInts:
    ...
    def test_parse_csv_ints_correctness(self, value: str, expected: list[int]) -> None:
    ...
    def test_parse_csv_ints_errors(self, value: str) -> None:
        """Test that parse_csv_ints raises errors for invalid input."""
        with pytest.raises(ValueError):
            parse_csv_ints(value)


class TestParseCSVIntsViaFloat:
    """Test parse_csv_ints_via_float function."""
    ...
    def test_parse_csv_ints_via_float_correctness(
        self, value: str, expected: list[int]
    ) -> None:
    ...
    def test_parse_csv_ints_via_float_errors(self) -> None:
...
# Benchmarks
class TestParseCSVIntsBenchmark:
    """Benchmark parse_csv_ints against Python baseline."""
    ...
    def test_parse_csv_ints_rust(
        self, benchmark: BenchmarkFixture, data: str
    ) -> None:
    ...
    def test_parse_csv_ints_python(
        self, benchmark: BenchmarkFixture, data: str
    ) -> None:
...
class TestParseCSVIntsViaFloatBenchmark:
    """Benchmark parse_csv_ints_via_float against Python baseline."""
...
class TestRealWorldBenchmarks:
    """Benchmark with real-world data patterns from actual device messages."""

    def test_stats_content_realistic(self, benchmark: BenchmarkFixture) -> None:
    ...
    def test_map_crc_values(self, benchmark: BenchmarkFixture) -> None:
