"""Deebot DEEBOT T50 PRO Water Supply & Discharge version (上下水版) Capabilities."""
# Same command set as T50 OMNI (nxeux7); verified live on a real device:
# status/battery/charge-state/map events all report correctly.
